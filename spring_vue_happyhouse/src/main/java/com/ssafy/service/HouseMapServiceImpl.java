...
public class HouseMapServiceImpl implements HouseMapService {
	...
	@Override
	public HouseInfoDto AptDetail(int aptCode) {
		return houseMapMapper.AptDetail(aptCode);
	}

	@Override
	public boolean aptPutHit(HouseInfoDto houseInfoDto) {
		
		return houseMapMapper.aptPutHit(houseInfoDto)==1;
	}

	@Override
	public CountDto Count() {
		
		return houseMapMapper.Count();
	}

	@Override
	public List<HouseInfoDto> getAll() {
		return houseMapMapper.getAll();
	}
