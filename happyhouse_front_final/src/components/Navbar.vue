<template>
  <div class="sticky top-0 z-40">
    ...
    <div
      ...
      v-else
    >
      <!-- <router-link to="/login" class="block px-4 py-2 hover:bg-gray-200"
        >Login</router-link
      > -->
      <!-- 
      <div>
      ...
      <!-- <router-link to="" class="block px-4 py-2 hover:bg-gray-200"
        >Join</router-link
      > -->
...
export default {
  ...
  methods: {
    ...
    onClickLogout() {
      ...
      // if (this.$route.path != "/") this.$router.push({ name: "DashboardHome" });
    },
  },
};
</script>
