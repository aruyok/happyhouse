  ...
  >
    ...
    <div class="mb-4 px-4">
      ...
      >
        ...
        <span class="text-gray-700" @click="gohome">메인</span>
      </div>
      <div
      ...
      >
        ...
        <router-link to="/dashboard/map"
          ><span class="text-gray-700">매물 검색</span></router-link
        >
      </div>
      <div
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
      >
        ...
        <router-link to="/dashboard/favorite" class="text-gray-700"
          >관심 매물 즐겨찾기</router-link
        >
      </div>
      <div
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
      >
        ...
        <router-link to="/dashboard/rank" class="text-gray-700"
          >랭킹</router-link
        >
      </div>
    ...
    <div class="mb-4 px-4">
      <p class="pl-4 text-sm font-semibold mb-1">BOARD</p>
      <div
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
      >
        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
        ...
        <router-link to="/dashboard/notice" class="text-gray-700"
          >Notices</router-link
        >
      </div>
      <!-- <div
      ...
      >
        ...
        <span class="text-gray-700">Q&A</span>
      </div> -->
      <!-- <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
              <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
